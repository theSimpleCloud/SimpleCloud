...
import eu.thesimplecloud.lib.exception.NoSuchServiceException
...
interface ICloudPlayer : IOfflineCloudPlayer {
     ...
     */
    fun getConnectedProxy(): ICloudService? = CloudLib.instance.getCloudServiceManger().getCloudServiceByName(getConnectedProxyName())

    /**
     * Returns the server this player is connected to.
     */
    fun getConnectedServer(): ICloudService? = getConnectedServerName()?.let { CloudLib.instance.getCloudServiceManger().getCloudServiceByName(it) }
     ...
     */
    fun teleport(location: SimpleLocation): ICommunicationPromise<Unit> = CloudLib.instance.getCloudPlayerManager().teleportPlayer(this, location)
     ...
     */
    fun hasPermission(permission: String): ICommunicationPromise<Boolean> = CloudLib.instance.getCloudPlayerManager().hasPermission(this, permission)
     ...
     */
    fun sendToLobby(): ICommunicationPromise<Unit> = CloudLib.instance.getCloudPlayerManager().sendPlayerToLobby(this)
