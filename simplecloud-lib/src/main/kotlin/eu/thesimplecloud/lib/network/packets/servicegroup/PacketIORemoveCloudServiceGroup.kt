...
class PacketIORemoveCloudServiceGroup() : JsonPacket() {
    ...
    override suspend fun handle(connection: IConnection): ICommunicationPromise<Unit> {
        ...
        val serviceGroup = CloudLib.instance.getCloudServiceGroupManager().getServiceGroupByName(groupName) ?: return failure(NoSuchElementException("Service is not registered"))
