...
enum class ServiceVersion(val serviceVersionType: ServiceVersionType, val downloadLink: String) {
    ...
    PAPER_SPIGOT_1_7_10(ServiceVersionType.SERVER_DEFAULT, "https://yivesmirror.com/grab/paper/PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest"),
    PAPER_SPIGOT_1_8_8(ServiceVersionType.SERVER_DEFAULT, "https://yivesmirror.com/files/paper/PaperSpigot-1.8.8-R0.1-SNAPSHOT-latest.jar"),
    PAPER_SPIGOT_1_11_2(ServiceVersionType.SERVER_DEFAULT, "https://yivesmirror.com/files/paper/PaperSpigot-1.11.2-b1104.jar"),
    PAPER_SPIGOT_1_12_2(ServiceVersionType.SERVER_DEFAULT, "https://yivesmirror.com/files/paper/Paper-1.12.2-b1618.jar"),
    PAPER_SPIGOT_1_13_2(ServiceVersionType.SERVER_DEFAULT, "https://yivesmirror.com/files/paper/Paper-1.13.2-b624.jar"),
    PAPER_SPIGOT_1_14_4(ServiceVersionType.SERVER_DEFAULT, "https://yivesmirror.com/files/paper/Paper-1.14.4-b210.jar");
