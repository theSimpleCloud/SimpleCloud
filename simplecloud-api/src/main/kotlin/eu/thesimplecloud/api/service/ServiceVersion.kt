...
enum class ServiceVersion(val serviceVersionType: ServiceVersionType, val downloadLink: String) {
    ...
    SPIGOT_1_15_1(ServiceVersionType.SERVER_DEFAULT, "https://cdn.getbukkit.org/spigot/spigot-1.15.1.jar"),
    ...
    PAPER_1_15_1(ServiceVersionType.SERVER_DEFAULT, "https://yivesmirror.com/files/paper/Paper-1.15.1-b35.jar");
